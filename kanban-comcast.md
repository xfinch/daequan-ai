# 📊 KANBAN BOARD — COMCAST
## Senior Business Account Executive Operations
...
| **Income Status** | Ramping (1 partial check so far) |
| **Next Action** | Xavier to define priorities |
...
- **Location:** 2620 N. Proctor St, Tacoma, WA 98407
- **Phone:** 253-327-1500
- **Main Contact:** Marie (handles all internet stuff)
- **Gatekeeper:** Stephan (bartender)
- **Context:** Met Stephan (gatekeeper/bartender). Marie is the main contact for all internet-related decisions.
- **Next Step:** Contact Marie to discuss current internet services and needs
- **Opportunity:** Brewery/restaurant — potential for business internet, Wi-Fi for customers, TV for sports/entertainment
...
- **Owner Status:** Owner currently in Arizona
- **Interest:** Wants meeting to review current bill and services
- **Context:** Met Andrew (decision-maker). He's interested in a bill review meeting. Owner is away but Andrew has authority to meet.
- **Next Step:** Follow up next week to schedule bill review meeting
- **Opportunity:** Restaurant bill review — potential for service optimization or switch
...
- **Priority:** HIGH
- **Automation Level:** HIGH (automated)
- **Description:** Research prospects before calls/meetings
- **Data Points:**
  - Company size, revenue, industry
  - Recent news, expansions, pain points
  - Decision-maker profiles
  - Current telecom setup (if detectable)
- **Delivery:** Pre-call brief to Xavier's Ray-Bans or WhatsApp

### 2. Proposal Generation System
- **Priority:** HIGH
- **Automation Level:** MEDIUM (template + customization)
- **Description:** Generate Comcast Business proposals
- **Inputs:** Client needs, size, current spend
- **Outputs:** Customized proposal with pricing, solutions

### 3. Follow-Up Automation
- **Priority:** MEDIUM
- **Automation Level:** HIGH (automated)
- **Description:** Scheduled follow-ups, check-ins, nurturing sequences
- **Channels:** Email, LinkedIn, phone reminders
- **Integration:** Salesforce/Comcast CRM?

### 4. Competitive Intelligence
- **Priority:** MEDIUM
- **Automation Level:** MEDIUM
- **Description:** Track competitor (Spectrum, CenturyLink, etc.) in Xavier's territory
- **Alerts:** Price changes, new offerings, outages

### 5. Commission/Performance Tracking
- **Priority:** LOW
- **Automation Level:** HIGH (automated)
- **Description:** Track deals, commissions, quota progress
- **Inputs:** Salesforce data, commission statements
...
- Multi-location account management tools
- Enterprise account deep-dive automation
- Partnership/referral program tracking
...
|--------|--------|---------|--------|
| Monthly Revenue | TBD | Minimal | Ramp-up |
| New Accounts | TBD | Starting | Building |
| Pipeline | TBD | Growing | Early |

---

## ⚙️ SYSTEMS ACCESS NEEDED

- [ ] Comcast CRM (Salesforce?)
- [ ] Commission tracking system
- [ ] Territory/account data
